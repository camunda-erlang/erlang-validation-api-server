...
request_params('validateSubscription') ->
    [
        'variables'
    ];
...
request_param_info('validateSubscription', 'variables') ->
    #{
        source =>   body,
        rules => [
            schema,
...
validate_response('validateSubscription', 200, Body, ValidatorState) ->
    validate_response_body('inline_response_200', 'inline_response_200', Body, ValidatorState);
validate_response('validateSubscription', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('validateSubscription', 404, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
